...
let WidgetPropsTable = class WidgetPropsTable extends LitElement {
    constructor() {
        super(...arguments);
        this.properties = [];
    }
...
__decorate([
    property({ type: Array })
], WidgetPropsTable.prototype, "properties", void 0);
WidgetPropsTable = __decorate([
    customElement('widget-props-table')
], WidgetPropsTable);
export { WidgetPropsTable };
